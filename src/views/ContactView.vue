<template>
  ...
  >
    ...
    <div
      :class="[
        'flex flex-col my-auto transition-all motion-reduce:transition-none duration-500 delay-300',
        visible
          ? 'translate-y-0 opacity-1 blur-0'
          : 'translate-y-4 opacity-0 blur-sm',
      ]"
      ...
      <div v-else class="space-y-8 mx-auto">
        ...
        >
          <template v-if="content.externalLink.link.email">
            ...
            <p class="text-sm mt-8 sm:mt-0 text-slate-500 dark:text-slate-300">
